...
class FetchUser extends DbConnection{
    ...
    public function getUsersFaculty(){
        ...
        $sql = "SELECT a.*, b.*, c.* FROM tbl_faculty AS a LEFT JOIN tbl_users AS b ON a.school_id_number = b.id_number LEFT JOIN tbl_department AS c ON a.dept_id = c.id";
        $query = $this->connection->query($sql);
    ...
    //J-O Users
    public function getUsersJO(){
 
        $sql = "SELECT a.*, b.* FROM tbl_jo AS a LEFT JOIN tbl_users AS b ON a.school_id_number = b.id_number";
        $query = $this->connection->query($sql);
